		...
		<div class="class2">
			<div class="class3">
				<form class="class4" method="post"
					action="http://localhost:8080/uRegister">
					<span class="class5 p-b-26"> Create User VideoSpace account
					</span> <span class="class5 p-b-48"> </span>

					<div class="class6">
						<input class="class7" type="text" name="uName" id="uName">
						<span class="class8" data-placeholder="Name"></span>
					</div>

					<div class="class6">
						<input class="class7" type="text" name="uEmail" id="uEmail">
						<span class="class8" data-placeholder="Email"></span>
					</div>
					<div class="class6">
						<span class="class7B"> Enter DOB </span> <input class="class7"
							type="date" name="uAge" id="uAge"> <span class="class8"
